// Partner data for the globe pins.
// Each entry: enabled, lat, lon, and the info shown in the hover box / used on click.
window.PARTNERS = [
  {
    enabled: false,
    lat: -39.2865, lon: 171.7763,
  ...
  {
    enabled: false,
    lat: -23.1555729, lon: 135.6020971,
  ...
  {
    enabled: false,
    lat: -27.1555729, lon: 135.6000971,
